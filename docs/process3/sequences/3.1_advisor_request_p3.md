...
sequenceDiagram
    ...
    alt not TEAM_LEADER
        ...
        AdvisorController-->>Student: 403 {"message": "Only the Team Leader can send advisor requests"}
    end
    ...
    alt group.status != TOOLS_BOUND
        ...
        AdvisorController-->>Student: 400 {"message": "Group must be in TOOLS_BOUND status to request an advisor"}
    end
    ...
    alt no active window
        ...
        AdvisorController-->>Student: 400 {"message": "Advisor association window is not currently active"}
    end
    ...
    alt pending request already exists
        ...
        AdvisorController-->>Student: 409 {"message": "Group already has an active pending advisor request"}
    end
    ...
    alt advisor not found or not a Professor
        ...
        AdvisorController-->>Student: 404 {"message": "Advisor not found"}
    end
    ...
    alt currentGroupCount >= advisor.advisorCapacity
        ...
        AdvisorController-->>Student: 400 {"message": "Advisor has reached maximum group capacity for this term"}
    end
...
sequenceDiagram
    ...
    alt student is not a member of this group
        AdvisorService-->>AdvisorController: throw ForbiddenException
        AdvisorController-->>Student: 403 {"message": "You are not a member of this group"}
    end
    ...
    alt no request exists
        ...
        AdvisorController-->>Student: 404 {"message": "No advisor request found for this group"}
    end
...
sequenceDiagram
    ...
    alt not TEAM_LEADER
        AdvisorService-->>AdvisorController: throw ForbiddenException
        AdvisorController-->>Student: 403 {"message": "Only the Team Leader can cancel advisor requests"}
    end
    ...
    alt group not found
        ...
        AdvisorController-->>Student: 404 {"message": "Group not found"}
    end
    ...
    alt no pending request
        AdvisorService-->>AdvisorController: throw BusinessRuleException
        AdvisorController-->>Student: 400 {"message": "No active pending request to cancel"}
    end
