...
sequenceDiagram
    ...
    alt not found
        ...
        AdvisorController-->>Professor: 404 {"message": "Request not found"}
    end

    alt request.advisorId != professorUUID
        AdvisorService-->>AdvisorController: throw ForbiddenException
        AdvisorController-->>Professor: 403 {"message": "This request is not addressed to you"}
    end
...
sequenceDiagram
    ...
    alt request.status != PENDING
        ...
        AdvisorController-->>Professor: 400 {"message": "Request is no longer pending"}
    end
...
sequenceDiagram
    ...
    alt currentGroupCount >= advisor.advisorCapacity
        ...
        AdvisorController-->>Professor: 400 {"message": "You have reached your maximum group capacity for this term"}
    end
