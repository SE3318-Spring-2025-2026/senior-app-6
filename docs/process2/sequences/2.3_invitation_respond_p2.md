...
sequenceDiagram
    ...
    alt invitation.inviteeId != studentUUID
        ...
        InvitationController-->>Student: 403 {"message": "This invitation does not belong to you"}
    end
...
sequenceDiagram
    ...
    alt group.status == DISBANDED
        ...
        InvitationController-->>Student: 400 {"message": "This group has been disbanded"}
    end

    alt group.status == TOOLS_BOUND or ADVISOR_ASSIGNED
        GroupService-->>InvitationController: throw BusinessRuleException
        InvitationController-->>Student: 400 {"message": "Group roster is locked after tool binding"}
    end
    ...
    alt memberCount >= maxTeamSize
        GroupService-->>InvitationController: throw BusinessRuleException
        InvitationController-->>Student: 400 {"message": "Group has reached maximum team size"}
    end
