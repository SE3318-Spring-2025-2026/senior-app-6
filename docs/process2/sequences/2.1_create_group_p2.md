...
sequenceDiagram
    ...
    alt no active window (empty or closesAt < now)
        ...
        GroupController-->>Student: 400 {"message": "Group creation window is not currently active"}
    end
    ...
    alt student already in a group
        ...
        GroupController-->>Student: 400 {"message": "You are already a member of a group"}
    end
    ...
    alt duplicate name in term
        ...
        GroupController-->>Student: 409 {"message": "A group named '{name}' already exists for this term"}
    end
...
sequenceDiagram
    ...
    alt no membership found
        ...
        GroupController-->>Student: 404 {"message": "You are not a member of any group"}
    end
