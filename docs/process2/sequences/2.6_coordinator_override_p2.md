...
sequenceDiagram
    ...
    CoordinatorGroupController->>GroupService: getGroupSummariesForActiveTerm()
...
sequenceDiagram
    ...
    alt not found
        ...
        CoordinatorGroupController-->>Coordinator: 404 {"message": "Group not found"}
    end
...
sequenceDiagram
    ...
    alt action is not ADD or REMOVE
        CoordinatorGroupController-->>Coordinator: 400 {"message": "action must be ADD or REMOVE"}
    end
    ...
    alt action == ADD
        ...
        alt group.status == DISBANDED
            ...
            CoordinatorGroupController-->>Coordinator: 400 {"message": "Cannot add a student to a disbanded group"}
        end
        ...
        alt student not found
            ...
            CoordinatorGroupController-->>Coordinator: 404 {"message": "Student '{id}' not found"}
        end
        ...
        alt already in a group
            GroupService-->>CoordinatorGroupController: throw BusinessRuleException
            CoordinatorGroupController-->>Coordinator: 400 {"message": "Student '{id}' is already a member of a group"}
        end
        ...
        alt memberCount >= maxTeamSize
            GroupService-->>CoordinatorGroupController: throw BusinessRuleException
            CoordinatorGroupController-->>Coordinator: 400 {"message": "Group has reached maximum team size"}
        end
        ...
        alt membership.role == TEAM_LEADER
            ...
            CoordinatorGroupController-->>Coordinator: 400 {"message": "Cannot remove Team Leader; transfer leadership first"}
        end
...
sequenceDiagram
    ...
    alt group.status == DISBANDED
        GroupService-->>CoordinatorGroupController: throw BusinessRuleException
        CoordinatorGroupController-->>Coordinator: 400 {"message": "Group is already disbanded"}
    end
