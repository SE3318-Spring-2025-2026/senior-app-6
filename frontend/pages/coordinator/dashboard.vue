<script setup lang="ts">
	import { AlertTriangle, LogOut, Play, FileText, ClipboardCheck, Send, ShieldX, Users, X, Building, Settings as SettingsIcon, CalendarClock } from "lucide-vue-next";
    ...
    <div class="mx-auto w-full max-w-5xl space-y-6">
      ...
      <div class="grid gap-4 md:grid-cols-3">
        ...
        >
          ...
          <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">
            Review group roster and manage member overrides.
          </p>
        </NuxtLink>
