...
const canEdit = computed(() => isLeader.value && (group.value?.status === "TOOLS_BOUND" || group.value?.status === "ADVISOR_ASSIGNED") && !!selectedDeliverable.value && !isDeadlinePassed.value);
