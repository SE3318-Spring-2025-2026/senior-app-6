...
/**
 * Professor Dashboard
 * Displays professor-specific features: student submissions, grading, feedback
 */
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                <div className="mb-4 inline-block rounded-lg bg-amber-100 p-3 dark:bg-amber-950/50">
                ...
                <button className="rounded-lg bg-amber-600 px-4 py-2 text-sm font-medium text-white hover:bg-amber-700 dark:bg-amber-700 dark:hover:bg-amber-600">
                  View Submissions
                </button>
              </div>
              ...
              <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                ...
                <p className="mb-4 text-slate-600 dark:text-slate-400">
                  View assignment grades and statistics
                </p>
